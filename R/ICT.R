#' @title Information and communication technology data from Pakistan Social and Living Standard Measures 2015
#' @name   ICT
#' @docType data
#' @keywords datasets
#' @usage data(ICT)
#' @description \code{ICT} data from Pakistan Social and Living Standard Measures 2015.
